...
while initial_run == 1:
    ...
    print("\n---Gracile Menu---")
    print("[0] 'Почати зі створення/підключення бази даних'\n"
          "[1] 'Створити запис'\n"
          "[2] 'Знайти запис'\n"
          "[3] 'Редагувати запис'\n"
          "[4] 'Видалити запис'\n"
          "[5] 'Показати всю базу'\n"
          "[6] 'Авто-імпортування з .xlsx'\n"
          "[7] 'Вихід'")
    ...
    try:
        if len(user_input) > 1:
            ...
            confirmation = input("Впевнені? Потрібно буде створити нову базу даних наступного разу... Y/N: ")
            if confirmation.upper() == "Y":
                initial_run -= 1
                print("Ви вийшли з програми")
            else:
                print("Вихід скасовано.")
        else:
